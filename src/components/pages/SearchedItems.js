...
const SearchedItems = ({ find, focus, sethover, setfocus }) => {
    ...
    return (
        <>
            {focus && <div className="absolute top-14 left-5 md:left-72 z-30 mt-2 w-90 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1" onMouseOver={() => sethover(true)} onMouseOut={() => sethover(false)}>
