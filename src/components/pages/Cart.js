        ...
        {list.length > 0 ? <div className="w-full text-gray-600 body-font lg:pt-16 md:flex md:px-5 lg:px-20">
          <div className="flex shadow-md my-10 w-full flex-col md:flex-row">
            <div className="w-full md:w-2/4 bg-white px-3 md:px-10 py-10">
              ...
              <Link to="/" className="flex font-semibold text-yellow-300 text-sm mt-10">

                <svg className="fill-current mr-2 text-yellow-300 w-4" viewBox="0 0 448 512"><path d="M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z" /></svg>
                Continue Shopping
              </Link>
