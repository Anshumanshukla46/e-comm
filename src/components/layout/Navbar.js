...
const Navbar = () => {
    ...
    return (
        <>
            <header className="lg:fixed w-full z-20 text-gray-100 h-28 bg-gradient-to-b from-[#ddb236] to-transparent  body-font px-3 md:px-5 lg:px-10 xl:px-15">
                <div className="w-full mx-auto flex flex-wrap px-1 md:px-5 py-2 justify-between items-center">
                    ...
                    <div className="w-1/2 md:w-1/3 flex justify-center items-center">
                        <div className="w-full md:w-4/5 flex justify-center items-center rounded border border-gray-300">
                            <input type="text" name="hero-field" className="w-full bg-gray-300 bg-opacity-30 focus:ring-2  focus:bg-white focus:border-gray-500 text-base outline-none text-black py-1 px-3 leading-6 transition-colors duration-200 ease-in-out placeholder:text-black" placeholder='Search'
                                onChange={change}
                                onFocus={activeFocus}
                                onBlur={activeBlur}
                            />
                            <div className='px-2 text-xl md:text-2xl cursor-pointer hover:bg-white hover:text-[##ddb236]'>
